...
def get_parser():
    ...
    parser.add_argument(
        "--output",
        default='/mnt/LinuxDataFast/Projects/nerf-auto-driving/data/third_party_det3D/fcos3d/result_kitti/training/label_2',
        help="A file or directory to save output results. "
        "If not given, will show output in an OpenCV window.",
    )
    parser.add_argument(
        "--label-dir",
        default='/mnt/LinuxDataFast/Datasets/KITTI/training/calib',
